header {
  ...
  url   = "https://mineiros.io/?ref=terraform-google-pubsub-subscription"

  badge "build" {
    image = "https://github.com/mineiros-io/terraform-google-pubsub-subscription/workflows/Tests/badge.svg"
    url   = "https://github.com/mineiros-io/terraform-google-pubsub-subscription/actions"
    text  = "Build Status"
  }

  badge "semver" {
    image = "https://img.shields.io/github/v/tag/mineiros-io/terraform-google-pubsub-subscription.svg?label=latest&sort=semver"
    url   = "https://github.com/mineiros-io/terraform-google-pubsub-subscription/releases"
...
section {
  title   = "terraform-google-pubsub-subscription"
  toc     = true
  content = <<-END
...
references {
  ref "homepage" {
    value = "https://mineiros.io/?ref=terraform-google-pubsub-subscription"
  }
  ...
  ref "variables.tf" {
    value = "https://github.com/mineiros-io/terraform-google-pubsub-subscription/blob/main/variables.tf"
  }
  ref "examples/" {
    value = "https://github.com/mineiros-io/terraform-google-pubsub-subscription/blob/main/examples"
  }
  ref "issues" {
    value = "https://github.com/mineiros-io/terraform-google-pubsub-subscription/issues"
  }
  ref "license" {
    value = "https://github.com/mineiros-io/terraform-google-pubsub-subscription/blob/main/LICENSE"
  }
  ref "makefile" {
    value = "https://github.com/mineiros-io/terraform-google-pubsub-subscription/blob/main/Makefile"
  }
  ref "pull requests" {
    value = "https://github.com/mineiros-io/terraform-google-pubsub-subscription/pulls"
  }
  ref "contribution guidelines" {
    value = "https://github.com/mineiros-io/terraform-google-pubsub-subscription/blob/main/CONTRIBUTING.md"
  }
}
